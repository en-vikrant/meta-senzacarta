...
struct mxcfb_rect {
	__u32 top;		/* starting X coordinate for update region */
	__u32 left;		/* starting Y coordinate for update region */
...
struct mxcfb_update_data {
	...
	unsigned int flags;					/* select options for the current update */
	int dither_mode;
	int quant_bit;
